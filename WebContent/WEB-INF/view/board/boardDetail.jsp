...
<script>
	$(function(){
		...
		$("#delete").click(function(){
			...
			if(a==true){
				location.href = "${pageContext.request.contextPath}/review/delete.do?no=${review.rNo}&notice=notice";
			}
				return false;
		})
...
${list }--%>
	...
	<c:if test="${Auth.uIsMgr == true}"> <!-- 매니저만 -->
		<div id="md">
						...
						<tr>
							...
							<tr>
								<td><!-- 댓글입력하는 택스트공간이야~~~~~~~~~~~~~~~~~~~~~ -->
									...
									<button class="btninsert" data-rno="${review.rNo}" data-gno="${review.rDNo.dNo}">등록</button>
								</td>
