...
public class WorkDialogPage {
	private int total; //전체 게시판의 글의 갯수
	private int currentPage; //현재 페이지 번호
	private List<WorkDialog> content; //현재 화면에 display될 게시판 리스트 내용
	...
	public WorkDialogPage(int total,int currentPage,int size, List<WorkDialog> content) {
		this.total=total;
	...
	public List<WorkDialog> getContent() {
		return content;
	}
	...
	public boolean hasNoWorkDialogs() {
		return total==0;
	}
	
	public boolean hasWorkDialogs() {
		return total>0;
	}
	...
	public String toString() {
		return "WorkDialogPage [total=" + total + ", currentPage=" + currentPage + ", content=" + content + ", totalPage="
